...
class Usuario extends \yii\db\ActiveRecord implements \yii\web\IdentityInterface {
    ...
    function validatePassword($password) {
        return $this->contraseña === md5($password); // Si se utiliza otra función de encriptación distinta a md5, habrá que cambiar esta línea
    }
    ...
    public static $tipoOptions = ['C'=>'Campo','E' => 'Entrada','P' => 'Produccion','S'=>'Salida','A' => 'Administrador'];
